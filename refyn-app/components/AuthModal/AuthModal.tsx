    ...
    <AnimatePresence>
      {isOpen && (
        <div className={styles.overlayWrapper}>
          ...
          {/* Full Screen Moving OpenPeeps Crowd Background */}
          <CrowdCanvas src="/all-peeps.png" rows={15} cols={7} />

          {/* Clean Floating Centered Login Card */}
          <motion.div
          ...
          >
            ...
            <div className={styles.header}>
              ...
              <h2 className={styles.title} id="auth-title">
                Welcome to <span className={styles.accent}>Refyn</span>
              </h2>
            ...
            {submitted ? (
              ...
              >
                ...
                <button className={styles.submitBtn} onClick={resetAndClose}>
                  Done
                </button>
              </motion.div>
            ) : (
              <div className={styles.body}>
                <div className={styles.oauthButtons}>
                  <button className={styles.oauthBtn} onClick={() => setSubmitted(true)}>
                ...
                <p className={styles.terms}>
                  By continuing, you agree to Refyn Terms of Service and Privacy Policy.
                </p>
              </div>
            )}
          </motion.div>
